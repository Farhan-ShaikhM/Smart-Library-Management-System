...
class RegisterLibrarianFunctionality:
    ...
    def register_librarian(self, full_name, email, password, confirm_password, phone, address="", date_of_birth=None):
        """
        ...
        if date_of_birth:
            ...
            if age < 18 or age > 80:
                messagebox.showerror("Error", "Librarian must be at least 18 years old and under 80 years old.")
                return
        ...
        try:
            ...
            cursor.execute("""
                ...
                VALUES (%s, %s, %s, %s, %s)
            """, (full_name, email, password, "Librarian", dob_obj))
            self.conn.commit()
            ...
            if u_Id:
                cursor.execute("""
                    INSERT INTO Librarian (u_Id, address, phone, date_created)
                    VALUES (%s, %s, %s, CURDATE())
                """, (u_Id, address if address else None, phone))
                self.conn.commit()
